...
![status](https://img.shields.io/badge/status-active-public-blue) ![lane](https://img.shields.io/badge/lane-client-work-purple) ![visibility](https://img.shields.io/badge/visibility-public-lightgrey) ![qnap](https://img.shields.io/badge/qnap-qnap-verified-green) ![proof](https://img.shields.io/badge/proof-required-red)

## 30-Second Pitch

AI-powered career campaign intelligence app. Evidence from the tracked tree: GitHub Actions, Next.js/web app, React UI, Supabase-backed app/data, Tailwind CSS, Vercel deployment.

## Live State

| Field | Value |
| --- | --- |
| GitHub | https://github.com/rodgemd1-lgtm/campaign-app |
| QNAP canonical/mirror | `ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/campaign-app.git` |
| Lane | `client-work` - client delivery workspaces |
| Visibility | `public` |
| Primary language | `TypeScript` |
| Last pushed | `2026-04-12T21:29:42Z` |
| QNAP status | `imported_to_qnap_gitea` |
| QNAP HEAD | `cdbd21344ac5` |
| Consolidation action | `merge-into` |
| Canonical target | `signal` |
...
- Repo deep dive: [campaign-app](https://github.com/rodgemd1-lgtm/Startup-Intelligence-OS/blob/claude/rig-sovereign-audit-mesh/docs/repositories/repo-deep-dives/campaign-app.md)
...
8 data/config/knowledge-like files; 2 docs/notes; 0 media/design assets; 2 sensitive-path-name matches.
...
51 tracked files across 25 directories. Code files: 40. Test files: 0. 8 data/config/knowledge-like files; 2 docs/notes; 0 media/design assets; 2 sensitive-path-name matches.

Aggregate GitHub tree size: `274.5 KB` across `51` blobs.
...
Full public inventory: [campaign-app.txt](https://github.com/rodgemd1-lgtm/Startup-Intelligence-OS/blob/claude/rig-sovereign-audit-mesh/docs/repositories/repo-file-inventories/campaign-app.txt)
...
- V6: Consolidation action is resolved: `merge-into`.
...
- Run a non-destructive merge review into `signal`.
- Create a fresh bundle/mirror backup and restore proof before archiving anything.
- Move only verified code, docs, and assets; leave secrets and runtime artifacts out of public docs.
