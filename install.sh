...
REPO_NAME='campaign-app'
REPO_SLUG='campaign-app'
DEFAULT_BRANCH='main'
GITHUB_URL='https://github.com/rodgemd1-lgtm/campaign-app'
GITHUB_RAW_BASE='https://github.com/rodgemd1-lgtm/campaign-app/raw/main'
QNAP_CLONE='ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/campaign-app.git'
